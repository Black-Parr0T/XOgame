...
function checkWin(Turn) {
    ...
    else if (boxes[1].innerHTML != '' && boxes[2].innerHTML != '' && boxes[3].innerHTML != '' && boxes[4].innerHTML != '' && boxes[5].innerHTML != '' && boxes[6].innerHTML != '' && boxes[7].innerHTML != '' && boxes[8].innerHTML != '' && boxes[9].innerHTML != ''){
        displayWinner('DRAW')
    }
}
...
function displayWinner(winner){
    ...
    if (winner === "CIRCLE"){
        ...
        Container.innerHTML = '<div class="winner"><h2 class="wHead">DRAW</h2><button class="btn" onClick="okPressed()">OK</button></div>'
    }
};
